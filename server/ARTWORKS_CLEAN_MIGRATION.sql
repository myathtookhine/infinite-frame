-- ==========================================
-- CLEAN ARTWORKS MIGRATION (DROP & RECREATE)
-- ==========================================
-- This script drops existing artworks tables and recreates them
...
-- Step 2: Drop existing tables (CASCADE removes dependent objects)
...
-- Step 4: Create artwork_attributes junction table
...
CREATE INDEX idx_artworks_admin_id ON artworks(admin_id);
...
CREATE INDEX idx_artworks_created_year ON artworks(created_year);
CREATE INDEX idx_artworks_name ON artworks(name);

CREATE INDEX idx_artwork_attributes_artwork_id ON artwork_attributes(artwork_id);
CREATE INDEX idx_artwork_attributes_attribute_id ON artwork_attributes(attribute_id);
...
-- ==========================================
-- Summary:
-- ✓ Dropped existing artworks tables
-- ✓ Created fresh artworks table with all fields
